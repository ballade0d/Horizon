    ...
    static public MethodAccess get(Class type) {
        ...
        synchronized (loader) {
            ...
            if (accessClass == null) {
                ...
                MethodVisitor mv;
                cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "xyz/hstudio/horizon/lib/com/esotericsoftware/reflectasm/MethodAccess",
                        null);
                {
                    mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
                    mv.visitCode();
                    mv.visitVarInsn(ALOAD, 0);
                    mv.visitMethodInsn(INVOKESPECIAL, "xyz/hstudio/horizon/lib/com/esotericsoftware/reflectasm/MethodAccess", "<init>", "()V");
                    mv.visitInsn(RETURN);
                    mv.visitMaxs(0, 0);
                    mv.visitEnd();
                }
