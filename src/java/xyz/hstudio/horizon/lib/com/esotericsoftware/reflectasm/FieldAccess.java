...
public abstract class FieldAccess {
    ...
    static public FieldAccess get(Class type) {
        ...
        synchronized (loader) {
            ...
            if (accessClass == null) {
                ...
                cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "xyz/hstudio/horizon/lib/com/esotericsoftware/reflectasm/FieldAccess",
                        null);
    ...
    static private void insertConstructor(ClassWriter cw) {
        ...
        mv.visitMethodInsn(INVOKESPECIAL, "xyz/hstudio/horizon/lib/com/esotericsoftware/reflectasm/FieldAccess", "<init>", "()V");
        mv.visitInsn(RETURN);
        mv.visitMaxs(1, 1);
        mv.visitEnd();
    }
