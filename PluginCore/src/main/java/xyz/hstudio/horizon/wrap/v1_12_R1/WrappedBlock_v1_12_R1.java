package xyz.hstudio.horizon.wrap.v1_12_R1;
...
public class WrappedBlock_v1_12_R1 implements IWrappedBlock {
    ...
    public WrappedBlock_v1_12_R1(final org.bukkit.block.Block block) {
    ...
    public WrappedBlock_v1_12_R1(final org.bukkit.World world, final BlockPosition bPos, final IBlockData data) {
    ...
    public boolean isOccluding() {
        return this.data.getBlock().isOccluding(this.data);
    }
    ...
    public Vector3D getFlowDirection() {
        ...
        nmsVec = data.getBlock().a(world, bPos, null, nmsVec);
        vec.setX(nmsVec.x);
        vec.setY(nmsVec.y);
        vec.setZ(nmsVec.z);
        return vec;
